 ...
 */
const val TERMINAL_KEYBOARD_HEIGHT_DP = 104
...
fun TerminalKeyboard(
    ...
    org.connectbot.bridge.BridgeKeyboard(bridge, imeVisible, onShowIme, onHideIme, onInteraction, onShortcutModifierChange, modifier)
